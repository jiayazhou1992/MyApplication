...
public class SystemUtils {
     ...
     * 
     * @return if 2 * availableProcessors + icon1 less than 8, return it, else return 8;
     ...
     * 
     * @param max
     * @return if 2 * availableProcessors + icon1 less than max, return it, else return max;
     */
